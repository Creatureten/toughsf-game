...
class Reaction():
    ...
    def show(self):
        ...
        try:
            print("|\ΔH={:.2f} kJ/mol,Ea={:.2f} kJ/mol".format(dH,propDict['ActivationEnergy_kJ__mol']))
        except KeyError:
            print("|\ΔH={:.2f} kJ/mol".format(dH))
        try:
            print("|\Autoignition={}K".\
                  format(propDict['AutoignitionTemperature_K']))
        except KeyError:
            pass
        try:
            print("|\Characteristics Length={}m".\
              format(propDict['CharacteristicLength_m']))
        except KeyError:
            pass
        print("\n")
